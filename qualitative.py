...
parser.add_argument('--model_path', type=str, default=r'C:\Users\33602\Desktop\598_mini_project\_Mon_Apr_25_10_43_05_2022\final_model.pth')
parser.add_argument('--scale_factor', type=int, default=4)
parser.add_argument('--test_directory', type=str, default=r'C:\Users\33602\Desktop\598_mini_project\image_SRF_4_set5')
...
def main():
    ...
    for i in range(len(image_list)):
        if image_list[i].split('.')[0][-2] == 'H':
            ...
            lr = Image.open(os.path.join(args.test_directory, image_list[i].replace('H', 'L'))).convert('RGB')
            hr = np.array(hr)
            lr = np.array(lr)
